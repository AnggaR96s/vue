  ...
  >
    ...
    <section>
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        class="DividerSvg-nhcneq-0 laHIGl"
      >
        <path
          ...
          class="WaveFooter___StyledPath-nrfszb-0 cijXdC"
        />
        <path
          d="M1920 144s-467.917 116.857-1027.243-17.294C369.986 1.322 0 45.578 0 45.578V250h1920V144z"
          class="WaveFooter___StyledPath2-nrfszb-1 hRcAMi"
        />
        <path
          ...
          class="WaveFooter___StyledPath3-nrfszb-2 bopVfe"
        />
      </svg>
    </section>
    <footer class="secondary text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0"></div>
